...
namespace ETLPipelineTool.Api.Controllers.V1
{
  ...
  public class FieldMappingController(IMediator mediator) : BaseApiController
  {
    ...
    {
      await mediator.Send(FieldMappingMapper.ToDeleteFieldMappingCommand(id), cancellationToken);
    }
    ...
    {
      await mediator.Send(FieldMappingMapper.ToUpdateFieldMappingCommand(dto), cancellationToken);
    }
