...
//        )
//        {
//            if (columns.TryGetValue(sourceFields[0], out var val) && val is not null)
//            {
...
//                try
//                {
//                    var configObj = JsonSerializer.Deserialize<Dictionary<string, object>>(
//                        transformConfig
//                    );
//                    if (
//                        configObj != null
//                        && configObj.TryGetValue("defaultValue", out var defaultValue)
//                    )
//                    {
