...
namespace ETLPipelineTool.Application.Features.FieldMappings.Mappings
{
  public static class FieldMappingMapper
  {
    ...
    public static UpdateFieldMappingCommand ToUpdateFieldMappingCommand(UpdateFieldMappingDto dto)
    {
      return new UpdateFieldMappingCommand(dto);
    }

    public static CreateFieldMappingCommand ToCreateFieldMappingCommand(CreateFieldMappingDto dto)
    {
